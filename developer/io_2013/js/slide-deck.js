...
SlideDeck.prototype.onBodyKeyDown_ = function(e) {
  ...
  switch (e.keyCode) {
    ...
    case 79: // O: Toggle overview
      this.toggleOverview();
      if (document.body.classList.contains("overview")){
        speak("Entering overview mode.");
      } else {
        speak("Leaving overview mode.");
      }
      break;
    ...
    case 27: // ESC: Hide notes and highlighting
      ...
      if (document.body.classList.contains('with-notes')) {
        ...
        message = "Turning off notes. ";
      }
      if (document.body.classList.contains('highlight-code')) {
        document.body.classList.remove('highlight-code');
        message = message + "Turning off code highlights. "
      }
      if (document.body.classList.contains('overview')) {
        this.toggleOverview();
        if (message.length > 0) {
        ...
        message = message + "Turning off overview mode.";
      }
      if (message.length > 0) {
          speak(message);
      }
    ...
    case 70: // F: Toggle fullscreen
      ...
      if (e.target == document.body && !(e.shiftKey && e.metaKey)) {
        if (document.mozFullScreen !== undefined && !document.mozFullScreen) {
          ...
          speak("Leaving full screen mode.");
    ...
    case 87: // W: Toggle widescreen
      ...
      if (e.target == document.body && !(e.shiftKey && e.metaKey)) {
        ...
        if (this.container.classList.contains("layout-widescreen")){
          speak("Wide screen mode enabled.");
        } else {
          speak("Wide screen mode off.");
        }
      }
      break;
  }
