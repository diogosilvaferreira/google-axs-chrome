...
\BeginAccSupp{method=plain,Alt={Faa di Bruno's formula. An identity that
    ...
    fraction with complex nary multiplicative and factorial expressions.  In
...
\BeginAccSupp{method=plain,Alt={The MathML representation of the quadratic
    formula.}}
\begin{figure}[t!]
  \begin{center}
    \leavevmode
...
\end{lstlisting}
    \caption{MathML representations of the quadratic formula~(\ref{eq:quadratic}).}
