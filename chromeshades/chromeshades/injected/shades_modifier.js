 ...
 */
cvox.ShadesModifier.prototype.processDOM = function() {
  ...
  cvox.BaseModifier.prototype.processDOM.call(this);
};
...
cvox.ShadesModifier.prototype.processNode = function(
  ...
  if (node.constructor == HTMLInputElement &&
    ...
    var label = cvox.DomUtil.getLabel(node, false);
    if (label) {
  ...
  if (node.constructor == HTMLUListElement ||
      ...
      (this.isLeafNode(node) && cvox.DomUtil.getText(node))) {
    newStyle += ' display:block;';
  }
